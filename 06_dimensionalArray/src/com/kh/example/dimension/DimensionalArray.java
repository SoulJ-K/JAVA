...
public class DimensionalArray {
	public void method1() {
		...
		iArr1 = new int[3][5]; // 정변배열 : 행과 열의 크기가 정해져있는 배열(행과 열의 크기가 고정적인 배열)
		
	}
	
	public void method2() {
		//int형의 iArr이라는 배열 이름의 3행 5열짜리 배열생성
		...
		//2. 이중 for문을 이용해여 값 기록
		System.out.println("iArr.length : " + iArr.length);
		System.out.println("iArr[1].length : " + iArr[1].length);
